...
athlete_list = [30471548, 156935385, 116831809,
                88497473, 113681541, 123893901, 147351790,
                5279093, 24839597,
                131361374,
                48844017, 7112960, 124343918, 99796410,
                172576622 ]
print(athlete_list)
  ...
  for j in range(len(activity_data)):
    ...
    if detailed_activity['description'] == None:
      ...
      if posted_val:
        ...
        hive_work.update_weekly_leaderboard(table, activity['id'], athletedb_response['Items'][0]['hive_user'], detailed_activity['calories'])
