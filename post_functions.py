...
def strava_screenshot(activity):
  ...
  time.sleep(3)
  if driver.find_elements("xpath", "/html/body/div[1]/div/div[4]/div[1]/div/div[2]/button[1]"):
  #if driver.find_elements("xpath", "/html/body/div[1]/div/div/button[1]"):
    print("Element exists!")
    driver.find_element("xpath", "/html/body/div[1]/div/div[4]/div[1]/div/div[2]/button[1]").click()
