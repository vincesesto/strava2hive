...
def post_to_hive(athlete_id, activity_details, bearer_token):
  ...
  **About the Athlete:** *{athlete_details[2]}*
  ...
  ''' + post_functions.post_footer() + post_functions.monthly_totals(athlete_id, month_runs, month_kms, month_calories, activity_details['type'])
  ...
  for i in range(len(activity_data)):
    ...
    if detailed_activity['description'] == None:
      ...
      if posted_val > 0:
        ...
        hive_work. update_weekly_leaderboard(table, athlete_details[6], athlete_details[1], detailed_activity['calories'])
