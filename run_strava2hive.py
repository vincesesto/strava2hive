...
def post_to_hive(athlete_id, activity_details):
  ...
  if activity_details['photos']['primary'] == None:
    #image_name img_link prof_image_name prof_img_link = post_functions.zero_image_post(author, activity_details['id'])
  ...
  for i in range(len(activity_data)):
    ...
    if detailed_activity['description'] == None:
      ...
      if posted_val > 0:
        ...
        record_post(athlete_details[6], activity['id'], activity['type'], activity_date, record_distance, detailed_activity['calories'], wcount, athlete_details[1])
